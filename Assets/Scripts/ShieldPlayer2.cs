...
public class ShieldPlayer2 : MonoBehaviour
{
    public int player2Counter; // counter for pickups
    ...
    void Update()
    {
        ...
        player2Counter = GameObject.Find("Player2/HatchPlayer2").GetComponent<PowerupCounterPlayer2>().player2Counter;

        if (player2Counter == 6 && enoughCollected == false)
        {
            StartCoroutine(ActivatePowerup());
            enoughCollected = true;
        }

        if (enoughCollected == true && player2Counter == 1)
